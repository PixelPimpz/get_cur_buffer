...
main() 
{
  ...
  #tmux set -g @nvim-info-unit "#[fg=#{@Dark4}]#{E:@TriangleL}#[bg=#{@Light0_S}]#[reverse]#{@nvim-info} #[bg=default]#[noreverse]#{E:@TriangleRInverse}"
  tmux set -g @nvim-info-unit "#[fg=#{@Dark4},default]#[push-default]#{E:@TriangleL}#[bg=#{@Light0_S}]#[reverse]#{@nvim-info} #[bg=default]#[noreverse]#[pop-default]#{E:@TriangleRInverse}"
}
main
